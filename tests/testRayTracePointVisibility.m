...
objVisibleProj_EllipsLocalPA = scatter(dProjectedPoints_UV(2, bVisiblePoints_EllipsLocalPA), dProjectedPoints_UV(1, bVisiblePoints_EllipsLocalPA), 5, ...
    'b', 'filled', 'DisplayName', 'RT + Ellips. Local PA');
hold on
objVisibleProj_ShadowRays = plot(dProjectedPoints_UV(2, bVisiblePoints_RTwithShadowRays), dProjectedPoints_UV(1, bVisiblePoints_RTwithShadowRays), ...
...
objMeshProj = scatter(dProjectedPoints_UV(2, :), dProjectedPoints_UV(1, :), 8, 'w', 'filled', 'DisplayName', 'Mesh vertices projection');

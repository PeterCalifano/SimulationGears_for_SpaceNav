...
dZaxisFrame0_W          = [0; 0; 1];
dLightPosition_W        = [1; 0; 0];
enumRangeSamplingMethod = EnumSphericalShellRangeSamplingMethod.UNIFORM_VOLUME;
enumAnglesSamplingMethod = EnumSphericalShellAnglesSamplingMethod.UNIFORM_SOLID_ANGLE;

% Scattering from spherical (uniform in spherical, not in R3 space)
% objPointCloudDataset = CRelativePoseUniformSampler.SamplePositionsFromSphericalShell(ui32NumOfPoses, ...
%                                                                                 dMinMaxRange, ...
%                                                                                 dMinMaxAzimuth, ...
%                                                                                 dMinMaxElevation, ...
...
%                                                                                 "enumRangeSamplingMethod", EnumSphericalShellRangeSamplingMethod.UNIFORM_RANGE, ...
%                                                                                 "enumAnglesSamplingMethod", EnumSphericalShellAnglesSamplingMethod.UNIFORM_AZ_EL);
% 
% figure;
...
objPointCloudDataset = CRelativePoseUniformSampler.SamplePositionsFromSphericalShell(ui32NumOfPoses, ...
                                                                                      ...
                                                                                      "enumRangeSamplingMethod", enumRangeSamplingMethod, ...
                                                                                      "enumAnglesSamplingMethod", enumAnglesSamplingMethod);

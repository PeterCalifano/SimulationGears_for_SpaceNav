...
% Build dynamics handle
objDynamicsFcnHandle = @(dTime, dKepState) EvalRHS_GaussPlanetary(dTime, ...
                                                                dKepState, ...
                                                                dGravParam, ...
                                                                dBodyRadius, ...
                                                                dJ2coeff, ...
                                                                ...
                                                                ui8PerturbationType);
% Propagate
[dIntegratedTimegrid, dKepTrajectory] = ode113(objDynamicsFcnHandle, ...
                                            dRequestedTimegrid, ...
                                            dKepState0, ...
                                            objOdeOpts);

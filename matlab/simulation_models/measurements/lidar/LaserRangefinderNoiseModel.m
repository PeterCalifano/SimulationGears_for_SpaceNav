...
arguments
    dWhiteNoiseSigma    (1,1) double {mustBeNumeric} 
    dMeasDistance       (1,1) double {mustBeNumeric} %#ok<INUSA>
    dConstantBias       (1,1) double {mustBeNumeric}  = 0.0
end
%% SIGNATURE
...
% dMeasDistance       (1,1) double %#ok<INUSA> DEVNOTE: Unused in current version
% dConstantBias       (1,1) double = 0.0
% -------------------------------------------------------------------------------------------------------------
%% OUTPUT
% dMeasErr
% -------------------------------------------------------------------------------------------------------------

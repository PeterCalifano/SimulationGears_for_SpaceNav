...
arguments
    enumTargetName      (1,:) {mustBeA(enumTargetName, ["string", "char", "EnumScenarioName"]), ...
        mustBeMember(enumTargetName, ["Apophis", "ApophisElongated", "Itokawa", "ItokawaModified", ...
        "Bennu", "Bennu_OREx", "Moon", "Mars", "Ceres", "Didymos", "Dydimos", "Eros", ...
        "FromShape", "Custom", "NotDefined", "passthrough"])}
...
if nargout > 2
    strShapeModelMetadata = struct( ...
        'enumScenarioName', enumTargetName, ...

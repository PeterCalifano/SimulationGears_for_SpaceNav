function [dIsIntersected, dUbarycenCoord, dVbarycenCoord, dRangeToIntersection, dIntersectionPoint] =  RayTwoSidedTriangleIntersection_MollerTrembore( ...
    dRayOrigin, ...
    dRayDirection, ...
    dTriangVert0, ...
    dTriangVert1, ...
...
q = [dRayDirection(2)*e2(3)-dRayDirection(3)*e2(2), dRayDirection(3)*e2(1)-dRayDirection(1)*e2(3), dRayDirection(1)*e2(2)-dRayDirection(2)*e2(1)]; %cross product
